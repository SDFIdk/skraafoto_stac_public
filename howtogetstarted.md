...
| datetime      | string    | Dato og tid formateret efter [RFC 3339, sektion 5.6](https://tools.ietf.org/html/rfc3339#section-5.6). Kan være en enkelt dato og tid eller intavaller separert med `/`. Der kan bruge to punktummer `..` for et åbent dato- og tidsinterval.                                                                                                           |
