...
| ------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| collectionid  | \[string] | Liste af `Collection` id'er.                                                                                                                                                                                                                                                                                                                                 |
...
| limit         | integer   | Default: 10, maks: 10000 <br>Angiver maks antallet af resultater der bliver returneret (page size). Yderligere forklaring findes i [dokumentationen](https://github.com/Dataforsyningen/skraafoto_stac_public/blob/main/dokumentation.md#context-extension) <br/>                                                                                            |
| pt            | string    | Angiver en bestemt side, der skal fremsøges i forhold til paging. Yderligere forklaring findes i [dokumentationen](https://github.com/Dataforsyningen/skraafoto_stac_public/blob/main/dokumentation.md#context-extension).                                                                                                                                   |
...
| filter        | string    | CQL-json udtryk til avanceret søgninger på specifikke `Item` properties. Yderligere forklaring findes i [dokumentationen](https://github.com/Dataforsyningen/skraafoto_stac_public/blob/main/dokumentation.md#filter-extension)                                                                                                                              |
| filter-lang   | string    | Default: `cql-json` <br>Angiver hvilket query-sprog filteret er skrevet i. Yderligere forklaring findes i [dokumentationen](https://github.com/Dataforsyningen/skraafoto_stac_public/blob/main/dokumentation.md#filter-extension). </br>                                                                                                                     |
| filter-crs    | string    | Default: `http://www.opengis.net/def/crs/OGC/1.3/CRS84`, understøtter også `http://www.opengis.net/def/crs/EPSG/0/25832`. <br>Angiver hvilket koordinatsystem geometrier `filter` er angivet i. Yderligere forklaring findes i [dokumentationen](https://github.com/Dataforsyningen/skraafoto_stac_public/blob/main/dokumentation.md#filter-extension) </br> |
...
| **Parameter** | **Type**  | **Description**                                                                                                                                                                                                                                                                                                                   |
| ------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| crs           | string    | Default: `http://www.opengis.net/def/crs/OGC/1.3/CRS84`, understøtter også `http://www.opengis.net/def/crs/EPSG/0/25832` <br>Angiver hvilket koordinatsystem response skal indeholde. Se [Crs Extension](https://github.com/Dataforsyningen/skraafoto_stac_public/blob/main/dokumentation.md#crs-extension).</br>                 |
| limit         | integer   | Default: 10, maks: 10000 <br>Angiver maks antallet af resultater der bliver returneret (page size). Se [Context Extension](https://github.com/Dataforsyningen/skraafoto_stac_public/blob/main/dokumentation.md#context-extension).<br/>                                                                                           |
